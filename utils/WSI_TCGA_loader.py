...
DATA_DIR = os.path.join(BASE_DIR, 'data/WSI/TCGA_128')
Train_dir_LUAD = os.path.join(DATA_DIR, 'LUAD/vgg_pca/Train/')
Test_dir_LUAD = os.path.join(DATA_DIR, 'LUAD/vgg_pca/Test/')
