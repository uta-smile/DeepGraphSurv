...
tox21_loader = namedtuple('smiles_loader',
                          'dataset_class, dataset_name, file_name, tasks, smiles_filed, split_frac, transformer')
nci_loader = namedtuple('smiles_loader',
                        'dataset_class, dataset_name, file_name, tasks, split_frac, smiles_filed, transformer')
